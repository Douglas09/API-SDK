...
type
  ...
  private
    ...
    FUsu_representante_idpk: integer;
  ...
  public
    ...
    property Usu_representante_idpk: integer read FUsu_representante_idpk write FUsu_representante_idpk;
  ...
  private
    ...
    FEmp_ramoatividade_idpk: string;
  ...
  public
    ...
    property Emp_crt_idpk: string read FEmp_crt_idpk write FEmp_crt_idpk;
    ...
    property Emp_plano_idpk: string read FEmp_plano_idpk write FEmp_plano_idpk;
    ...
    property Emp_cidade_idpk: string read FEmp_cidade_idpk write FEmp_cidade_idpk;
    ...
    property Emp_ramoatividade_idpk: string read FEmp_ramoatividade_idpk write FEmp_ramoatividade_idpk;
...
begin
  ...
  try value.TryGetValue<integer>('usu_representante_idpk', self.FUsu_representante_idpk); except end;
...
begin
  ...
  try value.TryGetValue<string>('crt', self.FCrt); except end;
  ...
  try value.TryGetValue<string>('emp_crt_idpk', self.FEmp_crt_idpk); except end;
  ...
  try value.TryGetValue<string>('emp_plano_idpk', self.FEmp_plano_idpk); except end;
  ...
  try value.TryGetValue<string>('emp_cidade_idpk', self.FEmp_cidade_idpk); except end;
  ...
  try value.TryGetValue<string>('emp_ramoatividade_idpk', self.FEmp_ramoatividade_idpk); except end;
