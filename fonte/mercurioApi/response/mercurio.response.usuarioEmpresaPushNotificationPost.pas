unit mercurio.response.usuarioEmpresaPushNotificationPost;
...
type
  ...
  TResponseClassUsuarioEmpresaPushNotificationPost = class
  private
    [Coluna('registros')]
...
{ TResponseClassUsuarioEmpresaPushNotificationPost }

constructor TResponseClassUsuarioEmpresaPushNotificationPost.Create;
begin
  Registros := TList<TRegistros>.Create;
end;

destructor TResponseClassUsuarioEmpresaPushNotificationPost.Destroy;
begin
...
constructor TResponseClassUsuarioEmpresaPushNotificationPost.CreateWithJson(const value : TJSonObject);
var arr : TJSONArray;
    obj : TJSONObject;
    x : integer;
begin
...
constructor TResponseClassUsuarioEmpresaPushNotificationPost.CreateWithJsonString(const value : string);
var obj : TJSONObject;
begin
  obj := TJSONObject(TJSONObject.ParseJSONValue(value));
  try
