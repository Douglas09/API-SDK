unit mercurio.response.estoque.postManual;
...
type
  ...
  TResponseClassEstoquePostManual = class
  private
    [Coluna('registros')]
...
{ TResponseClassEstoquePostManual }

constructor TResponseClassEstoquePostManual.Create;
begin
  Registros := TList<TRegistros>.Create;
end;

destructor TResponseClassEstoquePostManual.Destroy;
begin
...
constructor TResponseClassEstoquePostManual.CreateWithJson(const value : TJSonObject);
var arr : TJSONArray;
    obj : TJSONObject;
    x : integer;
begin
...
constructor TResponseClassEstoquePostManual.CreateWithJsonString(const value : string);
var obj : TJSONObject;
begin
  obj := TJSONObject(TJSONObject.ParseJSONValue(value));
  try
