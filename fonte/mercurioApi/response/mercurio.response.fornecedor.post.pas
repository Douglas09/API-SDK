unit mercurio.response.fornecedor.post;
...
type
  ...
  TResponseClassFornecedorPost = class
  private
    [Coluna('registros')]
...
{ TResponseClassFornecedorPost }

constructor TResponseClassFornecedorPost.Create;
begin
  Registros := TList<TRegistros>.Create;
end;

destructor TResponseClassFornecedorPost.Destroy;
begin
...
constructor TResponseClassFornecedorPost.CreateWithJson(const value : TJSonObject);
var arr : TJSONArray;
    obj : TJSONObject;
    x : integer;
begin
...
constructor TResponseClassFornecedorPost.CreateWithJsonString(const value : string);
var obj : TJSONObject;
begin
  obj := TJSONObject(TJSONObject.ParseJSONValue(value));
  try
