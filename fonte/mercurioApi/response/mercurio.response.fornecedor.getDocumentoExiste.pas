unit mercurio.response.fornecedor.getDocumentoExiste;
...
type
  ...
  TResponseClassFornecedorGetDocumentoExiste = class
  private
    [Coluna('registros')]
...
{ TResponseClassFornecedorGetDocumentoExiste }

constructor TResponseClassFornecedorGetDocumentoExiste.Create;
begin
  Registros := TList<TRegistros>.Create;
end;

destructor TResponseClassFornecedorGetDocumentoExiste.Destroy;
begin
...
constructor TResponseClassFornecedorGetDocumentoExiste.CreateWithJson(const value : TJSonObject);
var arr : TJSONArray;
    obj : TJSONObject;
    x : integer;
begin
...
constructor TResponseClassFornecedorGetDocumentoExiste.CreateWithJsonString(const value : string);
var obj : TJSONObject;
begin
  obj := TJSONObject(TJSONObject.ParseJSONValue(value));
  try
