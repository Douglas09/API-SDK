unit mercurio.response.transportador.getDocumentoExiste;
...
type
  ...
  TResponseClassTransportadorGetDocumentoExiste = class
  private
    [Coluna('registros')]
...
{ TResponseClassTransportadorGetDocumentoExiste }

constructor TResponseClassTransportadorGetDocumentoExiste.Create;
begin
  Registros := TList<TRegistros>.Create;
end;

destructor TResponseClassTransportadorGetDocumentoExiste.Destroy;
begin
...
constructor TResponseClassTransportadorGetDocumentoExiste.CreateWithJson(const value : TJSonObject);
var arr : TJSONArray;
    obj : TJSONObject;
    x : integer;
begin
...
constructor TResponseClassTransportadorGetDocumentoExiste.CreateWithJsonString(const value : string);
var obj : TJSONObject;
begin
  obj := TJSONObject(TJSONObject.ParseJSONValue(value));
  try
